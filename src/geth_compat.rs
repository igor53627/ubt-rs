...
#[cfg(test)]
mod tests {
    use crate::{Sha256Hasher, UnifiedBinaryTree, TreeKey, Stem, B256};
    ...
    fn test_stem_node_hash_single_value() {
        use crate::{StemNode, Sha256Hasher, Hasher};
    ...
    fn test_internal_node_hash_sha256() {
        use crate::{InternalNode, Node, StemNode, Sha256Hasher, Hasher};
        ...
        let internal = InternalNode::new(
            Node::Stem(stem1.clone()),
            Node::Stem(stem2.clone())
        );
